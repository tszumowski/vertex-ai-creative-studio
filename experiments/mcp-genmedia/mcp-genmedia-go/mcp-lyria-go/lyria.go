...
var (
	// MCP Server settings
	transport string
	version   = "1.0.11" // Version increment for CORS support
...
func main() {
	...
	if transport == "sse" {
		...
		log.Printf("Lyria MCP Server listening on HTTP at :8080/mcp with tool: %s and CORS enabled", lyriaTool.Name)
