...
SEMANTIC_TYPES = [
    ...
    me.SelectOption(label="Umbrella", value="umbrella"),
    me.SelectOption(label="Bag", value="bag"),
    me.SelectOption(label="Tie", value="tie"),
    me.SelectOption(label="Suitcase", value="suitcase"),
    ...
    me.SelectOption(label="Cow", value="cow"),
    ...
    me.SelectOption(label="Radiator", value="radiator"),
    me.SelectOption(label="Oven", value="oven"),
    me.SelectOption(label="Toaster", value="toaster"),
    ...
    me.SelectOption(label="Cell Phone", value="cell_phone"),
    me.SelectOption(label="Television", value="television"),
    ...
    me.SelectOption(label="Sandwich", value="sandwich"),
    me.SelectOption(label="Orange", value="orange"),
    me.SelectOption(label="Broccoli", value="broccoli"),
    me.SelectOption(label="Carrot", value="carrot"),
    ...
    me.SelectOption(label="Stool", value="stool"),
    me.SelectOption(label="Seat", value="seat"),
    me.SelectOption(label="Couch", value="couch"),
    me.SelectOption(label="Trash Can", value="trash_can"),
    ...
    me.SelectOption(label="Barrel", value="barrel"),
    me.SelectOption(label="Desk", value="desk"),
    me.SelectOption(label="Ottoman", value="ottoman"),
    ...
    me.SelectOption(label="Bathroom Counter", value="bathroom_counter"),
    ...
    me.SelectOption(label="Sconce", value="sconce"),
    ...
    me.SelectOption(label="Shelf", value="shelf"),
    ...
    me.SelectOption(label="Playingfield", value="playingfield"),
    me.SelectOption(label="Railroad", value="railroad"),
    me.SelectOption(label="Road", value="road"),
    me.SelectOption(label="Snow", value="snow"),
    me.SelectOption(label="Sidewalk Pavement", value="sidewalk_pavement"),
    me.SelectOption(label="Runway", value="runway"),
    me.SelectOption(label="Terrain", value="terrain"),
    ...
    me.SelectOption(label="Scissors", value="scissors"),
    me.SelectOption(label="Plaything Other", value="plaything_other"),
    me.SelectOption(label="Teddy Bear", value="teddy_bear"),
    me.SelectOption(label="Hair Dryer", value="hair_dryer"),
    me.SelectOption(label="Toothbrush", value="toothbrush"),
    ...
    me.SelectOption(label="Wine Glass", value="wine_glass"),
    me.SelectOption(label="Knife", value="knife"),
    me.SelectOption(label="Fork", value="fork"),
    me.SelectOption(label="Spoon", value="spoon"),
    me.SelectOption(label="Bowl", value="bowl"),
    me.SelectOption(label="Tray", value="tray"),
    ...
    me.SelectOption(label="Rider Other", value="rider_other"),
    ...
    me.SelectOption(label="Streetlight", value="streetlight"),
    me.SelectOption(label="Road Barrier", value="road_barrier"),
    ...
    me.SelectOption(label="Traffic Sign", value="traffic_sign"),
    me.SelectOption(label="Traffic Light", value="traffic_light"),
    me.SelectOption(label="Fire Hydrant", value="fire_hydrant"),
    me.SelectOption(label="Parking Meter", value="parking_meter"),
    me.SelectOption(label="Bench", value="bench"),
    me.SelectOption(label="Bike Rack", value="bike_rack"),
    me.SelectOption(label="Billboard", value="billboard"),
    me.SelectOption(label="Sky", value="sky"),
    me.SelectOption(label="Pole", value="pole"),
    me.SelectOption(label="Fence", value="fence"),
    me.SelectOption(label="Railing Banister", value="railing_banister"),
    ...
    me.SelectOption(label="Skis", value="skis"),
    me.SelectOption(label="Snowboard", value="snowboard"),
    me.SelectOption(label="Sports Ball", value="sports_ball"),
    ...
    me.SelectOption(label="Tennis Racket", value="tennis_racket"),
    me.SelectOption(label="Net", value="net"),
    me.SelectOption(label="Base", value="base"),
    me.SelectOption(label="Sculpture", value="sculpture"),
    ...
    me.SelectOption(label="Shower Curtain", value="shower_curtain"),
    ...
    me.SelectOption(label="Truck", value="truck"),
    me.SelectOption(label="Trailer", value="trailer"),
    me.SelectOption(label="Boat Ship", value="boat_ship"),
    me.SelectOption(label="Slow Wheeled Object", value="slow_wheeled_object"),
    me.SelectOption(label="River Lake", value="river_lake"),
    me.SelectOption(label="Sea", value="sea"),
    me.SelectOption(label="Water Other", value="water_other"),
    me.SelectOption(label="Swimming Pool", value="swimming_pool"),
    me.SelectOption(label="Waterfall", value="waterfall"),
    me.SelectOption(label="Wall", value="wall"),
    me.SelectOption(label="Window", value="window"),
    me.SelectOption(label="Window Blind", value="window_blind"),
]
